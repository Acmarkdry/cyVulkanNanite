...
namespace cyRenderGraph
{
	...
	public:
		...
		vk::DescriptorSetLayout GetDescriptorSetLayout(const DescriptorSetLayoutKey& descriptorSetLayoutKey)
		{
			...
			if (!descriptorSetLayout)
			{
				...
				std::vector<DescriptorSetLayoutKey::StorageBufferId> storageBufferIds;
				...
				std::vector<DescriptorSetLayoutKey::ImageSamplerId> imageSamplerIds;
				...
				std::vector<DescriptorSetLayoutKey::StorageImageId> storageImageIds;
		...
		{
			auto setBindings = DescriptorSetBindings()
		...
		vk::DescriptorSet GetDescriptorSet(DescriptorSetLayoutKey setLayoutKey, const DescriptorSetBindings& setBindings)
		{
	...
	private:
		...
		std::map<DescriptorSetLayoutKey, vk::UniqueDescriptorSetLayout> descriptorSetLayoutCache;
