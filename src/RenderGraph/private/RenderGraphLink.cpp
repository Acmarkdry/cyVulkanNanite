...
namespace cyRenderGraph
{
  ...
  void Core::SetDebugName(ImageData *imageData, std::string name)
  {
  ...
  RenderGraph *Core::GetRenderGraph()
  {
  ...
  DescriptorSetCache *Core::GetDescriptorSetCache()
  {
    return descriptorSetCache.get();
  }
  PipelineCache *Core::GetPipelineCache()
  {
